  ...
  <div class="box-wrap">
    ...
    <el-form class="form-wrap" ref="formRef" :model="formModel" :rules="formRules" :disabled="loading">
      ...
      <el-form-item prop="password2">
        <el-input size="large" placeholder="再次输入密码" v-model="formModel.password2" :maxlength="30" show-password />
      </el-form-item>
    ...
    <div>
      <span style="font-size: 1.4rem">注册代表您同意</span>
      <span style="font-size: 1.4rem; cursor: pointer; color: #409eff" @click="showTermsOfUse = true">使用条款</span>
      <span style="font-size: 1.4rem">和</span>
      <span style="font-size: 1.4rem; cursor: pointer; color: #409eff" @click="showPricacyPolicy = true">隐私保护政策</span>
      ...
      Apis.iam.user
        ...
        .then(result => {
          if (result && result.success) {
            ...
            ElMessageBox.alert(`欢迎使用「闲来 Admax」后台管理系统，请登陆`, '注册成功', {
              callback: action => {
